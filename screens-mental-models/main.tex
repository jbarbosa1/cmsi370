\documentclass[12pt]{article} % JD: You had an extra documentclass directive---wut?
\usepackage{cite}
...
% JD: Well, technically the mental models aren't the screens', but their users'.
...
% JD: Hrm, a little too much ``interaction'' in the last few sentences there.
...
% JD: There are mentions of "advancements" and "studies" here...and where there
%     are mentions, there should be references.
...
% JD: I think you mean that the learnability was *insufficient*, not "too much."
%     I mean, you really can't have "too much" learnability, right?
...
% JD: Above sentence runs on a bit; needs to be rewritten.
...
% JD: Over already?  It felt like your discussion was only now starting...
...
\bibliography{Screens} % JD: Fixed it for you.
