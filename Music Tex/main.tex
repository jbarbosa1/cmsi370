...
% JD: Well, more the reverse---you explored the degree to which guidelines compliance
%     might explain how the apps did in the field.
...
% JD: You had space---these could have been bigger.
\begin{figure}[H]
\centering
...
% JD: I see the reference at the end, but you should cite it here.
...
% JD: Your analysis is guidelines centric, which is fine, but as such, illustrations *from* the
%     guidelines would have helped in highlighting where the apps complied and/or diverged.
